...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo"><a href="https://www.notion.so/36ea729acf25437f87222ad720d6c02e?v=f84707c248a14174bbf51a13c333c7de&pvs=4" target="_blank"><img height="44" title="CodeIgniter Logo"
																					alt="Visit CodeIgniter Practico"
			...
			<li class="menu-item hidden"><a href="https://www.notion.so/36ea729acf25437f87222ad720d6c02e?v=f84707c248a14174bbf51a13c333c7de&pvs=4" target="_blank">Docs</a>
			</li>
			<li class="menu-item hidden"><a href="https://github.com/" target="_blank">Github</a></li>
			<li class="menu-item hidden"><a
					href="<?= base_url('/entrar');?>" target="_self">Login</a>
			</li>
		</ul>
	</div>
	...
	<div class="heroe">
		...
		<h1>Bienvenido a Practicas de CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
...
<section>
	...
	<p>Esta página esta enfocada para el estudio del Framework Codeigniter</p>
